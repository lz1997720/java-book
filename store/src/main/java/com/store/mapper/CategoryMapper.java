...
public interface CategoryMapper {
	...
	@Select("select id from category where name like '%${name}%'")
	public int selectCategoryId(@Param("name") String name);

	@Select("select id from goods where name like '%${name}%'")
	public int selectCategoryIdByGoodsName(@Param("name") String name);
